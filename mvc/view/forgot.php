              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="">
                    ...
                    <input type="submit" value="Submit" name='forgot' class='btn btn-primary btn-user btn-block'>
                  </form>
                  <hr>
                  <div class="text-center">
                  ...
                  <div class="text-center">
                    <a class="small" href="<?= BASEURL ?>/index.php?controller=user&action=show">Already have an account? Login!</a>
                  </div>
                </div>
              </div>
            </div>
