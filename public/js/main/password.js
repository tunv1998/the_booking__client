(function ($) {
    ...
    $.fn.passwordStrength = function (options) {
        ...
        $(this).keyup(function (event) {
            ...
            if (password.length == 0) {
                ...
                if (score < 30) {
                    $('#password-score').html('<span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true" style="color:red;font-size:12px;">Weak password</span>');
                    ...
                    $('#password-score').html('<span class="glyphicon glyphicon-ok" aria-hidden="true" style="color:#FFC200;font-size:12px;">Normal password </span>');
                    ...
                    $('#password-score').html('<span class="glyphicon glyphicon-ok" aria-hidden="true" style="color:blue;font-size:12px;">Strong password </span>');
                    ...
                    $('#password-score').html('<span class="glyphicon glyphicon-ok" aria-hidden="true" style="color:green;font-size:12px;">Very strong password</span>');
                    // $('#password-recommendation').html('');
                    $('#password-progress').removeClass();
    ...
    function checkcPassword(){
        var progressHtml = "<div class='progresscheck'></div>";
        ...
        if(cpassword===password){
            $('.progresscheck').html('<span class="glyphicon glyphicon-ok" aria-hidden="true" style="color:green; font-size:12px;">Veryfile password</span>');
        }else{
            $('.progresscheck').html('<span class="glyphicon glyphicon-ok" aria-hidden="true" style="color:red; font-size:12px;">Veryfile not password</span>');
        }
    });
}
