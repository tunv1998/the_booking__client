$(document).ready(function () {
    // Out focus
    // Validate email
    $("[name='hotelEmail']").keyup(function () {
    ...
    // Validate phone
    $("[name='hotelPhoneNum']").keyup(function () {
    ...
    $("[name='hotelName'],[name='roomtype_name'],#room-name,[name='hotelAddress']").keyup(function () {
        if (inputNotEmpty($(this), 100) && checkProfanity($(this).val())) {
            validateIsTrue($(this));
        }
        else {
            validateIsFalse($(this));
    ...
    // 
    $('[name="roomtype_count"],[name="roomtype_sqm"]').keyup(function () {
        if (inputNumLimit($(this).val(), 100)) {
            validateIsTrue($(this));
        }
        else {
            validateIsFalse($(this));
